defmodule HTTPGetter do
  ...
  def get macaroon_filename, cert_filename, url do
    case :httpc.request :get, { String.to_charlist(url), get_headers(macaroon_filename) }, get_options(cert_filename), [] do
  ...
  def main [cert, macaroon, url] do
    :ssl.start; :inets.start; get(cert, macaroon, url) |> IO.write
  end
